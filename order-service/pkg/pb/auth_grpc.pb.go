...
func (c *userServiceClient) GetOneUser(ctx context.Context, in *GetOneUserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
...
func (UnimplementedUserServiceServer) GetOneUser(context.Context, *GetOneUserRequest) (*UserResponse, error) {
